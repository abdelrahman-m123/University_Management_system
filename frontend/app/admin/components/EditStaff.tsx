    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="grid gap-1.5 px-6 pt-4">
            <label htmlFor="email" className="text-sm font-medium text-slate-700">Email (Read-only)</label>
            <Input
              id="email"
              type="email"
        ...
        <div className="grid gap-4 px-6 pb-4">
          <div className="grid gap-1.5">
            <label htmlFor="staff-name" className="text-sm font-medium text-slate-700">Staff Name *</label>
            <Input
              id="staff-name"
          ...
          <div className="grid gap-1.5">
            <label htmlFor="contact-info" className="text-sm font-medium text-slate-700">Contact Info</label>
            <Input
              id="contact-info"
