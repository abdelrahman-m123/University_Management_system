...
import { getCourse, getQuizzes, getRegisteredStudents, getGrades } from "../actions";
...
const CoursePage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchCourseDetails = async () => {
      try {
        ...
        const studentsResponse = await getRegisteredStudents(parseInt(courseId as string));
  ...
  const handleGradeUpdate = async () => {
    // Refresh students and grades data after grading
    const studentsResponse = await getRegisteredStudents(parseInt(courseId as string));
    setStudents(studentsResponse.students || []);
            ...
            <div className="bg-white rounded-xl text-blue-900 p-6 mb-6">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <DialogCreateQuiz courseId={courseId as string} handleUpdate={UpdatePage} />
                </div>
              </div>
            </div>
              ...
              <div className="mt-6">
                ...
                {activeTab === "grades" && (
                  <div>
                    ...
                    <StudentGradesTable grades={grades} />
                  </div>
                )}
